...
const SearchInput = (props) => {
	...
	useEffect(() => {
		const fetchAutocomplete = () => {
			fetch(
				`https://api.giphy.com/v1/gifs/search/tags?api_key=${apiKey}&q=${props.value}&limit=5`
			)
	...
	return (
		<div className="SearchInput">
			...
			<img
				className="SearchInput-illustration"
				src={illustration}
