...
const GifApp = () => {
	...
	//setting state for loader activation when fetching data
	...
	//function to add a little delay during gif fetching
	const delay = () => {
		setTimeout(() => {
			setIsFetching(false);
		}, 500);
	...
	return (
		<div className={isDark ? "GifApp darkMode" : "GifApp lightMode"}>
			<Header handleLightChange={lightChange} darkState={isDark} />
			<SearchInput
